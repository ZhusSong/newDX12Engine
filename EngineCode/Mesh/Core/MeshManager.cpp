...
CMeshManage::CMeshManage()
    ...
    , ViewMatrix(FObjectTransform::IdentityMatrix4x4())
    , ProjectMatrix(FObjectTransform::IdentityMatrix4x4())
{
...
void CMeshManage::PostDraw(float DeltaTime)
{
    ...
    FObjectTransform ObjectTransform;
    XMStoreFloat4x4(&ObjectTransform.World, XMMatrixTranspose(WVP));
    ObjectConstants->Update(0, &ObjectTransform);
}
