...
void FBackgroundRenderLayer::BuildShader()
{
	...
	VertexShader.BuildShaders(L"../newDX12Engine/Shader/Sky.hlsl", "VertexShaderMain", "vs_5_1", ShaderMacro);
	PixelShader.BuildShaders(L"../newDX12Engine/Shader/Sky.hlsl", "PixelShaderMain", "ps_5_1", ShaderMacro);
