...
void FDynamicReflectionCubeMap::SetViewportPosition(const fvector_3d& InCenterPoint)
{
	//捕获摄像机四个面
...
void FDynamicReflectionCubeMap::BuildViewport(const fvector_3d& InCenterPoint)
{
	//捕获摄像机四个面
	FTmpViewportCapture Capture(InCenterPoint);
...
void FDynamicReflectionCubeMap::BuildDepthStencil()
{
...
FDynamicReflectionCubeMap::FTmpViewportCapture::FTmpViewportCapture(const fvector_3d& InCenterPoint)
{
	BuildViewportCapture(InCenterPoint);
}

void FDynamicReflectionCubeMap::FTmpViewportCapture::BuildViewportCapture(const fvector_3d& InCenterPoint)
{
	//捕获摄像机四个面
